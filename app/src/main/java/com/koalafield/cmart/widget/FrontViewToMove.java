...
public class FrontViewToMove {
	...
	private RecyclerView listView;// 如果所需移动的视图为ListView或其子类的item项，传入视图容器，限制其上下滚动
	 ...
	 *            所要滑动的视图的容器
	 */
	public FrontViewToMove(View frontView, RecyclerView listView) {
		this.frontView = frontView;
	 ...
	 *            视图所要被移动的距离
	 */
	public FrontViewToMove(View frontView, RecyclerView listView, int xToMove) {
		this.frontView = frontView;
		this.listView = listView;
		this.xToMove = xToMove;
		moveListener();
